...
built to find. That is far more specific than searching for `nifH`, `nifD` and `nifK` independently.
...
You can still recover it as an *ordered* operon by telling Pynteny the truth: the (-) strand, and
